...
# move mpdecision & thermald because it is no longer needed
mv /system/lib/hw/power.msm8960.so /system/lib/hw/power.msm8960.so-bak;
mv /system/lib/hw/power.mako.so /system/lib/hw/power.mako.so-bak;
